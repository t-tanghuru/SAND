...
def parse_args():
    ...
    parser.add_argument("--spatial_dimension", default=3, type=int, help="Dimension of images: 2d or 3d.")
    ...
    parser.add_argument("--vqvae_num_res_channels", default=[128, 128, 128, 256], type=ast.literal_eval)
    ...
    parser.add_argument("--augmentation", type=int, default=1, help="Use augmentation: 1 or 0.")
    parser.add_argument("--adversarial_weight", type=float, default=0.01, help="Weight for adversarial component.")
    parser.add_argument("--adversarial_warmup", type=int, default=0, help="Warmup the adversarial component.")
