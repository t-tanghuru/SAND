#!/usr/bin/env python3
# Vendored verbatim from the official FreeSurfer repository:
#   https://github.com/freesurfer/freesurfer/blob/dev/mri_synthstrip/mri_synthstrip
#   commit cf4bccf24875a47245b4df9fc9372d0f1c3d784f
# Distributed under the FreeSurfer Software License Agreement (see
# https://github.com/freesurfer/freesurfer/blob/dev/LICENSE.txt); not
# authored by this project. Only change from upstream: this header comment.
#
# Cite: A. Hoopes, J.S. Mora, A.V. Dalca, B. Fischl, M. Hoffmann.
